document.addEventListener("DOMContentLoaded", async () => {
  ...
  const createCollectionWithPageBtn = document.getElementById("createCollectionWithPage");
  const createCollectionWithScreenshotBtn = document.getElementById("createCollectionWithScreenshot");
  ...
  chrome.storage.local.get("token", async ({ token }) => {
    ...
    return data; // { _id, cname }
    }

      createCollectionWithPageBtn.onclick = async () => {
        ...
        loading.style.display = "block";
        const data=await createCollection(cname);
